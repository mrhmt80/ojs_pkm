...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'numPageLinks' => 10,
  'numWeeksPerReview' => 4,
  'onlineIssn' => '2686-6501',
  'printIssn' => '',
  'publicationFee' => 0,
  'publisherInstitution' => 'Polinema',
  ...
  array (
    ...
    'dateUploaded' => '2020-06-23 08:14:46',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'en_US' => '<p>Jurnal Pengabdian Polinema Kepada Masyarakat</p>',
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Jurnal Pengabdian Polinema Kepada Masyarakat',
  ),
  'openAccessPolicy' => 
  array (
  ...
  'pageFooter' => 
  array (
    'en_US' => '<p><strong>Editorial Office:</strong> <br>Jurnal Pengabdian Polinema Kepada Masyarakat<br>LPPM Politeknik Negeri Malang <br>Jl. Soekarno Hatta No.9, Jatimulyo, <br>Kec. Lowokwaru Malang, Prov. Jawa Timur, Indonesia, 65411 <br>Telp. 0341 - 404424, upt.p2m@polinema.ac.id</p>',
  ),
  'privacyStatement' => 
  array (

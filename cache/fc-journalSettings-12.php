...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  array (
    ...
    'dateUploaded' => '2020-06-09 02:23:08',
  ),
  ...
  array (
    'en_US' => '<p>Jurnal Teknik Ilmu dan Aplikasi merupakan jurnal ilmiah yang berasal dari tugas akhir mahasiswa ataupun hasil penelitian mahasiswa yang berdasar dari teori berdasarkan lingkup teknik ilmu dan aplikasi lainnya. Jurnal ini terbit setahun dua kali yaitu pada bulan Juli dan Desember.&nbsp;&nbsp;</p>
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'en_US' => '<p>Jurnal Teknik Ilmu Dan Aplikasi</p>',
  ),
  'journalThumbnail' => 
  array (
    'en_US' => 
    array (
      ...
      'width' => 639,
      'height' => 840,
      'dateUploaded' => '2020-06-15 02:45:24',
      'altText' => '',
    ),
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Jurnal Ilmu Dan Aplikasi',
  ),
  'openAccessPolicy' => 
  array (
  ...
  'pageFooter' => 
  array (
    'en_US' => '<p>Jurnal Teknik Ilmu Dan Aplikasi<br>LPPM Politeknik Negeri Malang<br>Jl. Soekarno Hatta No.9, Jatimulyo, Kec. Lowokwaru<br>Malang, Prov. Jawa Timur, Indonesia, 65411<br>Telp. 0341 - 404424, upt.p2m@polinema.ac.id</p>',
  ),
  'privacyStatement' => 
  array (

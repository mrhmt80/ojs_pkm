...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  array (
    ...
    'dateUploaded' => '2020-06-07 12:14:34',
  ),
  ...
  array (
    'en_US' => '<p>Jurnal Informatika Polinema (JIP) Ditujukan sebagai sarana bagi peneliti, akademisi, dan praktisi untuk mempublikasikan hasil-hasil penelitian atau temuan, konsep dan ide terbaru mengenai Pengembangan Aplikasi Teknologi Informasi.</p>
...
<p>Template Artikel dapat diunduh&nbsp;<a href="https://drive.google.com/file/d/1t2vjKXewVbylzvx4ksK2hMYYA4Ai1o0z/view?usp=sharing" target="_blank" rel="noopener"><em><strong>DISINI</strong></em></a></p>',
  ),
  'authorInformation' => 
  array (
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  array (
    'en_US' => 
    array (
      'name' => 'Untitled-10.png',
      'uploadName' => 'journalThumbnail_en_US.png',
      'width' => 1240,
      'height' => 1754,
      'dateUploaded' => '2020-06-15 02:47:13',
      'altText' => '',
    ),
  ),
  ...
  'name' => 
  array (
    'en_US' => 'Jurnal Informatika Polinema',
  ),
  'openAccessPolicy' => 
  array (
  ...
  'pageFooter' => 
  array (
    'en_US' => '<p><strong>Jurnal Informatika Polinema</strong><br>LPPM Politeknik Negeri Malang<br>Jl. Soekarno Hatta No.9, Jatimulyo, Kec. Lowokwaru<br>Malang, Prov. Jawa Timur, Indonesia, 65411<br>Telp. 0341 - 404424, upt.p2m@polinema.ac.id</p>',
  ),
  'pageHeaderLogoImage' => 
  array (
    'en_US' => 
    array (
      ...
      'width' => 5532,
      'height' => 1150,
      'dateUploaded' => '2020-06-09 06:16:39',
      'altText' => '',
    ),
  ),
  'privacyStatement' => 
